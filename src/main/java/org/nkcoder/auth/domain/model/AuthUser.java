...
/**
 * Auth domain's representation of a user. Contains authentication-related data plus the name
 * (required for DB constraint). This is separate from the User domain's richer user model.
 */
public class AuthUser {
  ...
  public static AuthUser register(
      Email email, HashedPassword password, String name, AuthRole role) {
