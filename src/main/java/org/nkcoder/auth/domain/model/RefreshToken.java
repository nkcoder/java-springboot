...
/**
 * Entity representing a refresh token. Refresh tokens are used to obtain new access tokens without
 * re-authentication. They belong to a token family for multi-device logout support.
 */
public class RefreshToken {
  ...
  public static RefreshToken create(
      String token, TokenFamily tokenFamily, AuthUserId userId, LocalDateTime expiresAt) {
    return new RefreshToken(
        UUID.randomUUID(), token, tokenFamily, userId, expiresAt, LocalDateTime.now());
  }
