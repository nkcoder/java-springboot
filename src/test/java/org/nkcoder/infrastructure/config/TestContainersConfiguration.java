...
/**
 * The @TestConfiguration with @ServiceConnection and a reusable PostgreSQL container is the modern, Spring Boot 3.1+
 * recommended pattern for integration tests. Centralized Testcontainers configuration for all integration tests.
 *
 * <p>Why this approach is recommended:
 *
 * <ul>
 *   <li><b>@TestConfiguration</b>: Spring Boot loads this only in test contexts, keeping prod code clean.
 ...
 *   <li><b>Singleton Bean</b>: Spring creates a single container instance across all test classes that import this
 *       config, avoiding repeated startup overhead.
