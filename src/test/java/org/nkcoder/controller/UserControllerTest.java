...
@WebMvcTest(
        ...
        excludeFilters = {
            @ComponentScan.Filter(
                    ...
                    classes = {JwtAuthenticationFilter.class, SecurityConfig.class, JwtAuthenticationEntryPoint.class})
        })
class UserControllerTest extends BaseControllerTest {
    ...
    private UserResponse createTestUserResponse(UUID userId, String email, String name) {
        return new UserResponse(
                userId, email, name, Role.MEMBER, true, LocalDateTime.now(), LocalDateTime.now(), LocalDateTime.now());
    }
    ...
    class UserProfileTests {
        ...
        void shouldUpdateUserProfileSuccessfully() throws Exception {
            ...
            UserResponse updatedResponse = createTestUserResponse(testUserId, "newemail@example.com", "Jane Doe");
        ...
        void shouldReturnBadRequestWhenChangePasswordRequestIsInvalid() throws Exception {
            // Given
            ChangePasswordRequest request = new ChangePasswordRequest("", "weak", "weak"); // Invalid password
    ...
    class AdminUserManagementTests {
        ...
        void shouldUpdateUserAsAdmin() throws Exception {
            ...
            UserResponse updatedResponse = createTestUserResponse(testUserId, "admin@example.com", "Admin Updated");
        ...
        void shouldChangeUserPasswordAsAdmin() throws Exception {
            // Given
            ChangePasswordRequest request =
                    new ChangePasswordRequest("", "NewAdminPassword123!", ""); // Only newPassword is used for admin
