...
class AuthControllerTest extends BaseControllerTest {
    ...
    class RegistrationTests {
        ...
        void shouldRegisterUserSuccessfully() throws Exception {
            // Given
            RegisterRequest request = new RegisterRequest("test@example.com", "Password@123!", "John Doe", Role.MEMBER);
    ...
    class LogoutTests {
        ...
        void shouldLogoutFromSingleDeviceSuccessfully() throws Exception {
            ...
            // When & Then
            mockMvc.perform(post("/api/users/auth/logout-single")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(objectMapper.writeValueAsString(request)))
                    .andExpect(status().isOk())
    ...
    class ErrorHandlingTests {
        ...
        void shouldHandleServiceExceptionsProperly() throws Exception {
            ...
            given(authService.login(any(LoginRequest.class))).willThrow(new RuntimeException("Invalid credentials"));
