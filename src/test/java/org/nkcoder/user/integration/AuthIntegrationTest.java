...
public class AuthIntegrationTest extends IntegrationTestingBase {
    ...
    public void shouldRegisterThenLogin() {
        ...
        ResponseEntity<ApiResponse<AuthResponse>> registerResponse = testRestTemplate.exchange(
                registerUrl,
                HttpMethod.POST,
                new HttpEntity<>(new RegisterRequest("user1@email.com", "Your@password123", "user1", Role.MEMBER)),
        ...
        ResponseEntity<ApiResponse<AuthResponse>> loginResponse = testRestTemplate.exchange(
                loginUrl,
                HttpMethod.POST,
